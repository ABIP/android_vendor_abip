...
ALARM_PATH := vendor/abip/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/abip/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/abip/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/abip/prebuilt/common/media/audio/ui
